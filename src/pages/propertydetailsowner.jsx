...
import model3d from '../svgs/3dmodeling.svg'
import whiteClenderIcon from '../svgs/whitecalender-icon.svg'
import ImageCarousel from '../components/imagecarousel';
import owner from '../svgs/owner.svg'
// import { TbHexagon3D } from "react-icons/tb";
import { Link, useNavigate } from 'react-router-dom';
import CalendarDropdown2 from '../components/calenderdropdown2';
            ...
            <div className='side2 w-full md:w-[30%] flex flex-col'>
                <div className='flex flex-col w-[90%] mb-20 mt-[30%]' >
                  <div className='flex flex-row gap-2 w-[90%]  pb-[60px] ' style={{borderBottom:"1px solid black"}}>
                    <div>
                      <CalendarDropdown2 placeholder={"Take a 3D tour."} icon={model3d} width='400px' p='p-8' hoverbg='black' onClick={()=>navigate("/propertydetails/model")}/>
                      <CalendarDropdown2 placeholder={"Book a physical tour."} icon={whiteClenderIcon} width='400px' p='p-8' hoverbg='black' changeIcon={false}/>
                    </div>
                    {/* <div>
                  ...
                  <div className='attractions text-start mt-10 pb-5'>
                    ...
                    <div className='flex flex-row gap-3'>
                        <div className='w-14 h-14'>
                            <img src={owner} alt='profile' className='rounded-full w-full h-full'/>
                        </div>
                        <div>
                            <h3 className='text-start font-bold py-1'>Property Owner</h3>
                            <p className='text-start'>
                                Osamudiamen Imasuen
                            </p>
                            {/* link to review page */}
                            <Link to={"/base/profile"}>
                                <p className=' text-start text-xs underline'>
                                    Click to see review
                                </p>
                            </Link>
                        </div>
